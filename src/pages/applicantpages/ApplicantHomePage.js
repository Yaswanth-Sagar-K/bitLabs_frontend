...
import ApplicantDailyTest from'../../components/applicantcomponents/ApplicantDailyTest';
...
function ApplicantHomePage() {
  ...
  const updateActiveRoute = () => {
    ...
    switch (pathname) {
      ...
      case '/applicant-update-profile':
        ...
        break;
        case '/applicant-daily-test':
          setActiveRoute('dailytest');
          break;
      default:
        setActiveRoute('');
        break;
  ...
  return (
    <div  class="dashboard show"> 
     ...
     {activeRoute === 'dailytest' && <ApplicantDailyTest />}
      </div> 
  )
}
